                    ...
                    <div className="card" key={element._id}>
                      <div className="content">
                        <div className="short_fields">
                          <div>
                            <span>Title:</span>
                            <input type="text" disabled={editingMode!==element._id} 
                              value={element.title} 
...
<option value="">Select Category</option>
                        ...
                        <div className="edit_btn_wrapper">
                          {
                            ...
                            className="check_btn"><FaCheck/>
                            </button>
                            <button onClick={()=>handleDisableEdit()} 
                            className="cross_btn"><RxCross2/>
                            </button>
                            
                            
                            </>):(
                              <button onClick={()=>handleEnableEdit
                                (element._id)} className="edit_btn">Edit Button</button>
                            )
                          }
                          </div>
            ...
            <p>You have not posted any Job or maybe you've deleted all your jobs!</p>
          )}
        </div>
      </div>
    </>
